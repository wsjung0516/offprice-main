        ...
        >
          <div class="space-y-4">
            ...
            <div>
              <div class="flex justify-between mb-2">
                ...
                <a
                  [routerLink]="['/register-home/login/forgot-password']"
          ...
          <div class="space-y-2">
            ...
            <p class="px-6 text-sm text-center text-gray-600">
              ...
              <a
                [routerLink]="['/register-home/login/user-register']"
                rel="noopener noreferrer"
                href="#"
...
export class LoginComponent implements OnInit {
  ...
  constructor(private auth: RegisterAuthService, private titleService: Title) {}
