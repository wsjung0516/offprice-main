...
@Component({
  ...
  template: `
  <ng-container>
    <div class="z-100 flex h-48 w-76 bg-white flex-col rounded-md items-center justify-center opacity-1 ">
      <div class="flex flex-col items-center justify-center">
        <div class="flex items-center justify-start">
          <div class="m-4 p-2 w-64 h-14 border border-green-400 rounded-md bg-green-100  text-black flex items-center justify-start">
            <img src="assets/images/online-shopping.png" width="36" height="36" alt="">
            <div class="">
              <button [routerLink]="['/']" type="button" class="ml-4" (click)="onClose('shopping');">
        ...
        <div class="flex items-center justify-start">
          <div class="m-4 p-2 w-64 h-14 border border-green-400 rounded-md bg-green-100 text-black flex items-center justify-start" >
            ...
            <div class="">
              <button [routerLink]="['/register-home']" type="button" class="ml-4" (click)="onClose('register')">
