...
@Component({
  ...
  <div class="max-w-md">
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
      <div class="mb-4">
        <h4 class="text-dark text-gray-700">Forgot password</h4>
      </div>
      <form>
        <div class="mb-4">
        ...
        <div class="flex items-center justify-between mt-4">
          <a href="/login" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">Back to <span class="text-red-500">Login</span></a>
        </div>
      </form>
    </div>
  </div>
